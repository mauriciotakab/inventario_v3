    ...
    <div class="wrap">
        <div class="card">
            ...
            <div class="note">
                ...
                <b>En construcción.</b> Este módulo aún no está implementado. Aquí se integrará: planeación y ejecución de proyectos,
                 cronogramas, evidencias (fotos), entregables, cierre, reportes y dashboard de avances.
            </div>
